...
0. If you started an SSH session to your controller successfully, the prompt should have changed to `student@controller:~$`. From controller, source the `admin.rc` file. This changes your prompt and gives you OpenStack command authority.
