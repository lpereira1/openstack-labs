...
### Lab XY - Verifying the OpenStack Environment
...
0. SSH to your controller, log in as ender (this was covered in lab 00), and then issue the following command. This changes your prompt and gives you OpenStack command authority.
...
0. The command you issued above set *OpenStack environmental variables* Check them out as follows:
...
0. Make sure nova compute is running.  
 ...
 ### Checking OpenStack Version

0. Return to your home directory, and then source the `keystonerc_admin` file. We will discuss what this file does in subsequent lessons. For right now, understand that it is a way to set what user is interacting with OpenStack at the CLI.
