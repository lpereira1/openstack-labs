...
|Variable|Value|
|---|---|
|controller-addr|10.3.x.y|
|compute1-addr|10.3.x.y|
|compute2-addr|10.3.x.y|
|compute3-addr|10.3.x.y|
|mysql-bind-addr|10.3.x.y|
|MongoDB-smallfile|true|
|rabbitmqctl-user|openstack|
|ADMIN_TOKEN|11112222333344445555|
