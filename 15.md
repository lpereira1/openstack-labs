...
0. Let's make an rc file for chestercopperpot! Start issuing the following command to open vim.

    `student@controller (admin) :~$` `vim chester.rc`

0. Study, and then copy and paste the following content into **chester.rc** to create chestercopperpots permission file. 
