...
0. Click on the blue **Associate** button.
    ...
    ![Lab Environment](https://alta3.com/labs/images/alta3_lab_floating_ip_click_associate.png)

0. Great! Now your ping-box should have a second IP address applied to it! Record this IP address.

    ![Lab Environment](https://alta3.com/labs/images/alta_lab_horizon_new_floating_ip.png)
