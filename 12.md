...
15. Exit your SSH session to vt2

    `exit`

16. Start a new instance (vt3... whatever you want). Use the same security-group (http-ssh) and network as vt2

17. Attach the volume cargo-bay to the new instance vt3

18. SSH into vt3

19. Look at the new volume on vt3 and confirm it contains the file (Hello World!) that you created in step 2
