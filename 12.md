...
The objective of this lab is to create and work with groups and domains. These are both highly flexible concepts.

Domains are areas of administrative control. Each domain can have its own administrator, which controls projects within their domain.

Groups are designed to manage access and assign roles to multiple members at once. Groups contain some number of users, all of which you'd like to inheret some common permissions. Once again, back to our story. Time to take a third order.
