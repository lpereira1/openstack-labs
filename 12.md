...
18. Discover the vault-tek router ID
...
24. Confirm detachment  (Wait until status changes from "detaching" to "Available"
...
21. Attach the volume cargo-bay to the new instance vt3
    ...
    `nova volume-attach <vt2-ID> <cargo-bay-ID> auto`

22. SSH into vt3

23. Mount cargo bay

23. Look at the new volume on vt3 and confirm it contains the test file that you created.
