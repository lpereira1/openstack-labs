...
10. Before we finish in Horizon, make sure your VMs are active and running (powered on). Navigate to **Project > Compute > Instance**, and then click the **Start Instace** beside any VMs that are currently listed as Shutoff and Shut down (powered off). 
