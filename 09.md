...
### New linux untilities for this lab
...
3. Create a vault-tek-network router 
    ...
    | id                    | 5fddef2e-5cf4-4bb9-8617-57c2b9be8489 |
...
4. Connect vault-tek-router to the public network then show the router using less with horizontal scrolling
    
    `[root@controller] ~(keystone_chestercopperpot)# neutron router-gateway-set vault-tek-router public`

    `[root@controller] ~(keystone_chestercopperpot)# neutron router-show 5fddef2e-5cf4-4bb9-8617-57c2b9be8489  | less -S`

    Just for fun, show the router WITHOUT using less

    `[root@controller] ~(keystone_chestercopperpot)# neutron router-show 5fddef2e-5cf4-4bb9-8617-57c2b9be8489`
