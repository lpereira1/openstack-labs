...
0. Open a browser to the OpenStack Dashboard and log in. Domain: **default** UN: **admin** PW: **alta3**
...
0. Create floating IP addresses and assign them to the demo vms.  Make sure to replace the *<FLOATING IP>* values with the results from the previous command.
