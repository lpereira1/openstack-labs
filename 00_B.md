...
0. Remember, you enter vim in command mode. Take advantage of that, and press the following to jump to the end of the file:

  - `G`

0. Press the following to begin appending at the end of the line (enter --INSERT-- mode at the end).
...
0. Review a vim cheat sheet. You may have seen these hanging in your colleges workspaces, http://www.viemu.com/a_vi_vim_graphical_cheat_sheet_tutorial.html
