...
0. Issue the following command to determine the version release you are running, then use the link below to corelate that version to a specific release (i.e. Newton, Mitaka, Kilo, Juno...) 

    `student@controller (admin) :~$` `openstack manage --version`
