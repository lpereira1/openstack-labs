...
1. You likely already are connected to the controller via SSHProxy, but if not, sign into controller using SSHProxy (https://alta3.com/sshproxy/), and then issue these commands
