...
0. Answer the following questions to confirm that you understand the lab environment:
    ...
    - **Q2: Can I use the Microsoft Edge browser to complete the labs?**
      - Q2: Yes. You CAN use Microsfot Edge to complete the labs, just like you CAN walk from Maine to Florida. However, there are better options such as Chrome, Firefox, or Safari.
