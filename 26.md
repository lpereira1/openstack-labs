...
draft: false
weight: 260
title: "Lab 26 - Neutron Networking at the CLI between VMs"
---
...
0. **IMPORTANT** record the **floating** IP address that has been displayed to you (172.16.2.xx)
...
0. **IMPORTANT** record the **private** IP address that has been applied to vt2nofloat.
...
0. Okay, so that didn't work. We could apply a floating IP address to vt2nofloat, and SSH to it. However, let's SSH to the floating IP address of vt2, then SSH to the private IP address of vt2nofloat. To start, SSH to vt2's floating IP address.
