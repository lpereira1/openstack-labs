...
### Lab XY - Using Horizon - &#x2B50;REQUIRED&#x2B50;

### Lab Objective

The objective of this lab is to learn to use Horizon, the GUI (aka BUI, front-end, web interface) to explore the OpenStack environment. This is the environment that we can expect our customers to become accustomed to using.
