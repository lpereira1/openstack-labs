...
0. The Launch Instance dialog box will pop up. Fill out each tab as follows:
    ...
    >
      Allocated: cirros (selections are made by pressing the + button... selections are removed by pressing the - button)
    >
      **Flavor**
    >
      Allocated: m1.tiny (selections are made by pressing the + button... selections are removed by pressing the - button)
    >
      **Networks**
    >
      Allocated: provider-net (selections are made by pressing the + button... selections are removed by pressing the - button)
    >
      **Network Ports**
    >
      (No changes)
