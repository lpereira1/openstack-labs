...
0. Back to the terminal. Test your work by trying to connect to github.com. **Note:** *You'll need to type 'Yes' to accept the RSA key fingerprint after running this step.*
