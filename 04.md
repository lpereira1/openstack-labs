...
9. Edit **chester.rc** so it looks like the following. 
...
10. After you save the file and quit, display the contents of **chester.rc** and verify that they are correct.
