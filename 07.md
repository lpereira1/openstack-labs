 ...
 * If the instance is not ACTIVE and Running, let the instructor know
    ...
    > As a result, this will store the Tenant ID in $VT1.  Here how it works:  
    > VT1 is a variable name  
    > The backticks `` `  ` `` surrounds the entire nova command to cause the results to be placed oin the variable $VT1  
